...
7. Double-click the file to start infram.
...
3. Pick the connection type: SSH, RDP, VNC, or Telnet.
4. Enter the server name or IP address.
5. Add the port number if needed.
6. Enter your login details.
7. Save the connection.
8. Open it from your list when you need it.
...
## 📌 Connection details to have ready
